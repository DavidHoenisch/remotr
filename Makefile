...
provider-matrix-apt-repository-popos-24-04:
	chmod +x scripts/provider-matrix-apt-repository-container.sh
	./scripts/provider-matrix-apt-repository-container.sh popos-24.04 pop 24.04
