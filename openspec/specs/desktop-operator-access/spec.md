# Desktop Operator Access Specification

## Purpose

Define secure Operator profiles, authentication, authorization, desktop bridge boundaries, and Linux delivery behavior.
