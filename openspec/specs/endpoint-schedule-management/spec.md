# Endpoint Schedule Management Specification

## Purpose

Define safe, convergent management of endpoint-local schedules across supported Linux backends.
