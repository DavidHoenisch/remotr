...
- [ ] 1.1 Register OS-AEC-093 through OS-AEC-103 in `test/traceability.yaml` and link them to configuration CLI, provider-contract, container, VM safety/recovery, capability-advertisement, and audit selectors.
