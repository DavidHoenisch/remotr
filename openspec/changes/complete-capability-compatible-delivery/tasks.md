...
- [ ] 2.1 For OS-AEC-088, write and observe a focused red canonical digest mismatch test, then implement the versioned document model and deterministic canonical encoding.
