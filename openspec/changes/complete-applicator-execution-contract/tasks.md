...
- [x] 5.6 Promote governing traceability entries only after their required selectors pass, record any expiring evidence exception, and close umbrella tasks 2.9–2.11 only after this change is accepted.
