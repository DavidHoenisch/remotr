...
- [x] 1.1 For OS-LPC-029 and OS-LPC-030, add the production capability-document test that requires the PopOS 24.04 amd64 unblock set and keeps ARM/other releases fail-closed; record the intended red failure.
...
- [x] 3.1 Record OS-LPC-029/030 in OpenSpec, traceability, and focused documentation without advertising Ubuntu Pro on PopOS.
