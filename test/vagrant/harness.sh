...
network_recovery() {
  ...
  (
    ...
    vagrant ssh -c 'sudo rm -f /tmp/remotr-vm-hosts-entry.test /tmp/remotr-vm-network-resources.test /tmp/remotr-vm-network-profile.test /tmp/remotr-vm-recovery-token'
