...
system_safety() {
  ...
  (
    ...
    vagrant ssh -c 'sudo rm -f /tmp/remotr-vm-reboot-safety.test /tmp/remotr-vm-firewall-recovery.test /tmp/remotr-vm-access-recovery.test /tmp/remotr-vm-certificate-recovery.test /tmp/remotr-vm-trust-anchor.test /tmp/remotr-vm-apparmor.test /tmp/remotr-vm-audit-rules.test /tmp/remotr-vm-sysctl-safety.test /tmp/remotr-vm-hostname-safety.test'
    vagrant ssh -c '. /etc/os-release; test "$ID" = ubuntu; test "$VERSION_ID" = 24.04'
  ...
  (
    ...
    vagrant ssh -c 'sudo rm -rf /var/lib/remotr-vm-reboot-safety /var/lib/remotr-vm-system-safety /usr/local/lib/remotr-vm-reboot-safety.test /usr/local/lib/remotr-vm-firewall-recovery.test /usr/local/lib/remotr-vm-access-recovery.test /usr/local/lib/remotr-vm-certificate-recovery.test /usr/local/lib/remotr-vm-trust-anchor.test /usr/local/lib/remotr-vm-apparmor.test /usr/local/lib/remotr-vm-audit-rules.test /usr/local/lib/remotr-vm-sysctl-safety.test /usr/local/lib/remotr-vm-hostname-safety.test'
  )
