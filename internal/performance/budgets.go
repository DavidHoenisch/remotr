...
var requiredBudgetMetrics = []string{
	...
	"fleet.errors",
	"fleet.redis_replacement.p95_ns",
	"fleet.redis_outage_fallback.p95_ns",
	"redis.commands_per_eligible_hit",
	"redis.backend_connections",
	"redis.keys_per_400_endpoints",
	"server.heap_bytes",
	"server.goroutines",
	"server.cpu_jiffies_per_wave",
	"database.backends",
	"database.deadlocks",
	"server.unchanged_sync_hit.ns_op",
	"server.unchanged_sync_hit.bytes_op",
	"server.unchanged_sync_hit.allocs_op",
	"server.unchanged_sync_miss.ns_op",
